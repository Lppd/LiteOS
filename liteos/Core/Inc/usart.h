...
#define UART2_BUFF_SIZE   64 //?????????
#define UART3_BUFF_SIZE   64 //?????????
#define UART4_BUFF_SIZE   64 //?????????
...
extern USART_RECEIVETYPE Uart2Rx;
extern USART_RECEIVETYPE Uart3Rx;
extern USART_RECEIVETYPE Uart4Rx;

void USART1_ReceiveIDLE(void);
void USART3_ReceiveIDLE(void);
